...
const Dashboard: React.FC<DashboardProps> = ({ courses, evaluations, logs, exams }) => {
  // --- DATA CALCULATIONS ---
    ...
    <div className="space-y-8 animate-fade-in pb-12">
      ...
      <section>
        ...
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-8">
          {courses.map(course => (
            <ModuleIntelligenceCard key={course.id} course={course} logs={logs} exams={exams} />
          ))}
        </div>
      </section>
      ...
      <div className="bg-white p-8 rounded-3xl shadow-sm border-2 border-gray-100">
         <div className="flex justify-between items-center mb-8">
            <h3 className="text-xl font-black text-gray-800 flex items-center gap-2">
              <BarChart size={22} className="text-purple-500" /> Distribución de Horas por Contenido
            </h3>
         </div>
         <div className="h-80">
            <ResponsiveContainer width="100%" height="100%">
...
const ModuleIntelligenceCard: React.FC<{ course: Course; logs: ClassLog[]; exams: Exam[] }> = ({ course, logs, exams }) => {
    ...
    <div className="bg-white p-6 rounded-3xl border-2 border-gray-100 shadow-md flex flex-col md:flex-row gap-6 hover:shadow-xl transition-shadow group">
      ...
      <div className="flex-1 space-y-4">
        ...
        <div className="flex items-center justify-between pt-2 border-t border-gray-100">
           ...
           <button className="text-[10px] font-black text-chef-600 hover:text-chef-800 uppercase flex items-center gap-1 group/btn">
